-- Restore quiz-assignment email delivery for unsent and future alerts.
...
where push_delivery.event_type = 'quiz_assigned'
...
where deliveries.user_id = profiles.id
  and deliveries.event_type = 'quiz_assigned'
